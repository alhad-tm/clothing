  ...
  return (
    <div className="about w-full min-h-screen flex flex-col items-center justify-center text-gray-700 py-12 md:py-0">
      ...
      <motion.span 
       ...
       transition={{duration:0.3,delay:0.2}}className="text-4xl uppercase font-black">About</motion.span>
      <motion.span
      ...
      className="about-text">For the little ones, our kids' collection is designed with fun and comfort in mind. We offer playful and adorable outfits perfect for everyday adventures, special occasions, and seasonal wear. With a focus on quality and customer satisfaction, Milana is your go-to destination for both ladies' and kids' fashion.</motion.span>
      </div>
    </div>
  )
}
